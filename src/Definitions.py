...
import os, ssl, shutil, sys, socket, select, time, copy, subprocess, queue;
from OpenSSL import *;
...
SEV_HIGH = "High";   # invalid CA certificate becomes valid
SEV_MED = "Medium";  # invalid leaf certificate becomes valid
SEV_LOW = "Low";     # compliance issue

# rank macros for ease of execution
EASE_HIGH = "High";  # require no CA or compliant CA with basic server sign
EASE_MED = "Medium"; # require non-compliant CA with server sign
EASE_LOW = "Low";    # require CA with CA sign or compromise of other information
